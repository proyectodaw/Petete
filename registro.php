...
<form id="fRegistro" action="procesoRegistro.php" method="post" onsubmit="return validar();">
            ...
            <div id="c">
                ...
                <input type="checkbox" name="terminos" id="terminos"/><label id="lTerminos">Acepta las <a href="condiciones.php" TARGET="_new">condiciones generales</a> y la <a href="privacidad.php" TARGET="_new">politica de privacidad de PETETES</a></label><span id="errTerminos"></span><br /><br />
